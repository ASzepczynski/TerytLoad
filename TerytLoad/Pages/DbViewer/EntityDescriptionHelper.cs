...
namespace TerytLoad.Pages.DbViewer
{
    ...
    {
        /// <summary>
        /// Zwraca opis encji: wywo³uje Opis() jeœli istnieje, inaczej konkatenuje pola przez |
        /// </summary>
        public static string GetDescription<T>(T entity) where T : class
        {
            ...
            // SprawdŸ czy istnieje metoda Opis()
        ...
        /// <summary>
        /// Zwraca opis encji z u¿yciem konfiguracji ViewerConfig
        /// </summary>
        public static string GetDescription(object entity, ViewerConfig? config = null)
        {
            ...
            // U¿yj ViewerConfig jeœli dostêpny
            if (config != null)
            {
        ...
        /// <summary>
        /// Sprawdza czy typ jest prosty (nie jest obiektem z³o¿onym)
        /// </summary>
